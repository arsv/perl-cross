...
check hasfunc memmem "NULL, 0, NULL, 0" 'stdlib.h string.h'
...
check hasfunc newlocale '0,NULL,0' 'stdlib.h locale.h'
check hasfunc freelocale '0' 'locale.h'
check hasfunc uselocale '0' 'locale.h'
check hasfunc duplocale '0' 'locale.h'
